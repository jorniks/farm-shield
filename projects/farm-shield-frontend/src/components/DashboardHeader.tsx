        ...
        <span>
          {theme === "dark" ? (
            <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none">
              ...
              <rect x="0.5" y="0.5" width="41" height="41" rx="20.5" stroke="white" stroke-opacity="0.12" />
              <defs>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none">
              ...
              <rect x="0.5" y="0.5" width="41" height="41" rx="20.5" stroke="#2EA15C" stroke-opacity="0.2" />
              <defs>
